...
const AppointmentDetails = () => {
    ...
    const fetchAppointmentDetails = async (): Promise<void> => {
        try {
            setLoading(true);
            const response = await axiosClient.get(`/appointment/getSpecificappointment/${id}?usertype=partner`);
    ...
    const handleFileUpload = async (): Promise<void> => {
        ...
        try {
            ...
            const res = await axiosClient.post(`/appointment/uploadreport/${id}?usertype=partner`, formData, {
                headers: {
    ...
    const handleDeleteAppointment = async (): Promise<void> => {
        ...
        try {
            ...
            const res = await axiosClient.delete(`/appointment/deleteappointement/${id}?usertype=partner`);
            if (res.status == 200) {
    ...
    const handleUpdateStatus = async (status: string) => {
        try {
            const res = await axiosClient.post('/appointment/updatestatus?usertype=partner', {
                status: status,
                appointmentId: id
            });
    ...
    const handleMarkAsPaid = async (Paidstatus: string) => {
        ...
        try {
            const res = await axiosClient.post('/appointment/markaspaid?usertype=partner', {
                appointmentId: id
            });
                    ...
                    <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <p className="font-medium">{appointment.bookedBy.hospitalName}</p>
                            </div>
                        ...
                        <div className="mt-4">
                            ...
                            <div className="flex items-center mt-1">
                                ...
                                <p>{appointment.bookedBy.hospitalName}</p>
                            </div>
                            <div className="flex items-center mt-1">
